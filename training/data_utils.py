...
from text import (
    ...
    text_to_sequence,
    text_to_sequence_aligned,
    text_to_sequence_charbert,
    text_to_sequence_g2p,
)
...
class TextAudioLoader(torch.utils.data.Dataset):
    ...
    def __init__(self, audiopaths_and_text, hparams):
        ...
        self.charbert = getattr(hparams, "charbert", False)
...
class TextAudioSpeakerLoader(torch.utils.data.Dataset):
    ...
    def _filter(self):
        ...
        print(len(self.audiopaths_sid_text[0]))
...
class DistributedBucketSampler(torch.utils.data.distributed.DistributedSampler):
    ...
    def __init__(
        ...
        self.buckets, self.boundaries, self.num_samples_per_bucket = (
